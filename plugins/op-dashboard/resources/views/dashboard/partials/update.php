...
<!--<a class="opd-button opd-button-update opd-product-button---><?php //echo $product->uid ?><!--" href="--><?php //echo OPDashboard\product_update_url($product->uid) ?><!--">--><?php //_e('Update', 'opd') ?><!--</a>-->
<a href="<?php echo $updateUrl; ?>"
   class="update-op-product-link opd-button opd-button-update opd-product-button-<?php echo $product->uid ?>"
