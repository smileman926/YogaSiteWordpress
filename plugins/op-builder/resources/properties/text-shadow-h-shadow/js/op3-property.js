...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.TextShadowHShadow = OP3.defineClass({

        Name: "OP3.Property.TextShadowHShadow",
        ...
        Prototype: {
            ...
            proxy: function() {
                ...
                // 'HShadow' at end)
                this._proxy = this.element.findProperty(this.id().replace(/HShadow$/, ""));
