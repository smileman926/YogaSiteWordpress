...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.TextShadowBlurRadius = OP3.defineClass({

        Name: "OP3.Property.TextShadowBlurRadius",
        ...
        Prototype: {
            ...
            proxy: function() {
                ...
                // 'BlurRadius' at end)
                this._proxy = this.element.findProperty(this.id().replace(/BlurRadius$/, ""));
