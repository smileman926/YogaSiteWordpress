...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.TextShadowVShadow = OP3.defineClass({

        Name: "OP3.Property.TextShadowVShadow",
        ...
        Prototype: {
            ...
            _name: "textShadowVShadow",

            _defaults: {
                label: function() {
                    return OP3._("Horizontal Shadow");
                },
                attr: {
            ...
            proxy: function() {
                ...
                // 'VShadow' at end)
                this._proxy = this.element.findProperty(this.id().replace(/VShadow$/, ""));
