/**
 * OptimizePress3 StackColumnsMobile property
 *
...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.StackColumnsMobile = OP3.defineClass({

        Name: "OP3.Property.StackColumnsMobile",
        ...
        Prototype: {
            ...
            _name: "stackColumnsMobile",

            _defaults: {
                label: function() {
                    return OP3._("Stack Columns on Mobile");
                },
            ...
            computed: function() {
                return $(this.proxy().target()).attr("data-op3-stack-columns-mobile") || "0";
            },
            ...
            setter: function(value, media) {
                ...
                $(this.proxy().target()).attr("data-op3-stack-columns-mobile", value || "0");
            },
