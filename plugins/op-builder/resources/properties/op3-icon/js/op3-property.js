...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.Op3Icon = OP3.defineClass({

        Name: "OP3.Property.Op3Icon",
    ...
    OP3.bind("loadelementicons", function(e, o) {
        OP3.Elements._extension.prop.Op3Icon.prototype._defaults.options = OP3.Icons.data();
    });
