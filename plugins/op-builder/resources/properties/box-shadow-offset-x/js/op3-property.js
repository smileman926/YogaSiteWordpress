...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.BoxShadowOffsetX = OP3.defineClass({

        Name: "OP3.Property.BoxShadowOffsetX",
        ...
        Prototype: {
            ...
            _name: "boxShadowOffsetX",

            _defaults: {
                label: function() {
                    return OP3._("Offset X");
                },
                attr: {
            ...
            proxy: function() {
                ...
                // 'OffsetX' at end)
                this._proxy = this.element.findProperty(this.id().replace(/OffsetX$/, ""));
