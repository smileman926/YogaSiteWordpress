/**
 * OptimizePress3 StackColumnsTablet property
 *
...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.StackColumnsTablet = OP3.defineClass({

        Name: "OP3.Property.StackColumnsTablet",
        ...
        Prototype: {
            ...
            _name: "stackColumnsTablet",

            _defaults: {
                label: function() {
                    return OP3._("Stack Columns on Tablet");
                },
            ...
            computed: function() {
                return $(this.proxy().target()).attr("data-op3-stack-columns-tablet") || "0";
            },
            ...
            setter: function(value, media) {
                ...
                $(this.proxy().target()).attr("data-op3-stack-columns-tablet", value || "0");
            },
