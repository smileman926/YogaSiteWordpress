...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.BoxShadowSpread = OP3.defineClass({

        Name: "OP3.Property.BoxShadowSpread",
        ...
        Prototype: {
            ...
            proxy: function() {
                ...
                // 'Spread' at end)
                this._proxy = this.element.findProperty(this.id().replace(/Spread$/, ""));
