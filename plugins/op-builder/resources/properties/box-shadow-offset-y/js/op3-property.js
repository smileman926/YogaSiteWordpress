...
;(function($, window, document) {
     ...
     * @param {Class}
     */
    OP3.Elements._extension.prop.BoxShadowOffsetY = OP3.defineClass({

        Name: "OP3.Property.BoxShadowOffsetY",
        ...
        Prototype: {
            ...
            _name: "boxShadowOffsetY",

            _defaults: {
                label: function() {
                    return OP3._("Offset Y");
                },
                attr: {
            ...
            proxy: function() {
                ...
                // 'OffsetY' at end)
                this._proxy = this.element.findProperty(this.id().replace(/OffsetY$/, ""));
