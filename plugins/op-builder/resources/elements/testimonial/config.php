...
return array(
     ...
     */
    'thumb' => 'op3-icon op3-icon-contacts-44-1',
    ...
    'options' => array(
        'all' => array(
            ...
            'blockDisplayLogo' => '0',
            'blockDisplayTitle' => '0',
            'blockDisplayAvatar' => '0',
            'blockDisplayCompany' => '0',
            'blockDisplayAuthor' => '0',
        ),
    ),
    ...
    'presets' => array(
        array(
            'title' => 'Preset #1',
            'thumb' => op3_asset('img/elements/testimonial/styles/style-1.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' => 'auto',
                    'marginRight' => 'auto',
                    'authorFontSize' => '17px',
                    // 'avatarMarginTop' => '0px',
                    // 'avatarMarginBottom' => '0px',
                    'avatarMarginRight' => 'auto',
                    'avatarMarginLeft' => 'auto',
                    'avatarWidth' => '100px',
                    'blockLayoutDesktop' => '2',
                    'blockLayoutMobile' => '2',
                    'blockDisplayTitle' => '1',
                    'blockDisplayAvatar' => '1',
                    'blockDisplayCompany' => '1',
                    'blockDisplayAuthor' => '1',
                    'companyColor' => '#808080',
                    'companyFontWeight' => '400',
                    'logoMarginRight' => 'auto',
                    'logoMarginLeft' => 'auto',
                    'titleFontSize' => '28px',
                    'titleFontWeight' => '600',
                    // 'titleMarginTop' => '10px',
                    ...
                    'testimonialItemBackgroundColorBase' => 'rgba(0, 0, 0, 0)',
                    'testimonialItemBorderTopLeftRadius' => '0px',
                    'testimonialItemBorderTopRightRadius' => '0px',
                    'testimonialItemBorderBottomRightRadius' => '0px',
                    'testimonialItemBorderBottomLeftRadius' => '0px',
                    'testimonialItemBorderTopWidth' => '0px',
                    'testimonialItemBorderRightWidth' => '0px',
                    'testimonialItemBorderBottomWidth' => '0px',
                    'testimonialItemBorderLeftWidth' => '0px',
                    'testimonialItemJustifyContent' => 'flex-start',
                ),
            ),
        ),
        array(
            'title' => 'Preset #2',
            'thumb' => op3_asset('img/elements/testimonial/styles/style-2.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' => 'auto',
                    'marginRight' => 'auto',
                    ...
                    'testimonialItemBorderBottomRightRadius' => '0px',
                    'testimonialItemBorderBottomLeftRadius' => '0px',
                    'testimonialItemBorderTopWidth' => '1px',
                    'testimonialItemBorderRightWidth' => '1px',
                    'testimonialItemBorderBottomWidth' => '1px',
                    'testimonialItemBorderLeftWidth' => '1px',
                    'testimonialItemJustifyContent' => 'flex-start',
                ),
            ),
        ),
        array(
            'title' => 'Preset #3',
            'thumb' => op3_asset('img/elements/testimonial/styles/style-3.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' => 'auto',
                    'marginRight' => 'auto',
                    ...
                    'titleMarginLeft' => 'auto',
                    'testimonialItemBackgroundColorBase' => 'rgba(0, 0, 0, 0)',
                    'testimonialItemBorderTopLeftRadius' => '8px',
                    'testimonialItemBorderTopRightRadius' => '8px',
                    'testimonialItemBorderBottomRightRadius' => '8px',
                    'testimonialItemBorderBottomLeftRadius' => '8px',
                    'testimonialItemBorderTopWidth' => '1px',
                    'testimonialItemBorderRightWidth' => '1px',
                    'testimonialItemBorderBottomWidth' => '1px',
                    'testimonialItemBorderLeftWidth' => '1px',
        ...
        array(
            'title' => 'Preset #4',
            'thumb' => op3_asset('img/elements/testimonial/styles/style-4.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' => 'auto',
                    'marginRight' => 'auto',
                    ...
                    'titleMarginRight' => 'auto',
                    'titleMarginLeft' => 'auto',
                    'testimonialItemBackgroundColorBase' => 'rgba(0, 0, 0, 0.04)',
                    'testimonialItemBorderTopLeftRadius' => '8px',
                    'testimonialItemBorderTopRightRadius' => '8px',
                    'testimonialItemBorderBottomRightRadius' => '8px',
                    'testimonialItemBorderBottomLeftRadius' => '8px',
    ...
    'presetIncludeProperties' => array(
        'all' => array('blockLayoutDesktop', 'blockLayoutTablet', 'blockLayoutMobile', 'blockDisplayTitle', 'blockDisplayAvatar', 'blockDisplayCompany', 'blockDisplayLogo', 'blockDisplayAuthor'),
    ),
