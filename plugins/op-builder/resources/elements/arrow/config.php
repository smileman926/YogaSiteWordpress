...
return array(
    ...
    'styles' => array(
        array(
            'id' => 'arrow',
            'title' => 'Arrow',
            'thumb' => op3_asset('img/elements/arrow/styles/arrow.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/arrow.svg'),
        ),
        array(
            'id' => 'curved',
            'title' => 'Curved',
            'thumb' => op3_asset('img/elements/arrow/styles/curved.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/curved.svg'),
        ),
        array(
            'id' => 'double',
            'title' => 'Double',
            'thumb' => op3_asset('img/elements/arrow/styles/double.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/double.svg'),
        ),
        array(
            'id' => 'double2',
            'title' => 'Double2',
            'thumb' => op3_asset('img/elements/arrow/styles/double2.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/double2.svg'),
        ),
        array(
            'id' => 'normal',
            'title' => 'Normal',
            'thumb' => op3_asset('img/elements/arrow/styles/normal.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/normal.svg'),
        ),
        array(
            'id' => 'rotated',
            'title' => 'Rotated',
            'thumb' => op3_asset('img/elements/arrow/styles/rotated.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/rotated.svg'),
        ),
        array(
            'id' => 'triangle',
            'title' => 'Triangle',
            'thumb' => op3_asset('img/elements/arrow/styles/triangle.svg'),
            'markup' => op3_element_markup(OP3_ASSETS_PATH . 'img/elements/arrow/styles/triangle.svg'),
        ),
    ),
