...
return array(
     ...
     * acceptDrop)
     */
    //'dropTarget' => ' .op3-popoverlay-content',
    'dropTarget' => '',
     ...
     */
    'assets' => array(
        op3_asset_path('js/op3-element-popoverlay.js'),
    ),
    ...
    'descendants' => array(
        /*
        '.op3-element[data-op3-element-type="section"]' => array(
            'all' => array(
                'paddingTop' => '0px',
                'paddingBottom' => '0px',
            ),
        ),
        '.op3-element[data-op3-element-type="row"]:eq(0)' => array(
            'all' => array(
                'paddingTop' => '25px',
                'paddingBottom' => '25px',
                'paddingLeft' => '20px',
                'paddingRight' => '20px',
                'backgroundColorBase' => 'rgb(61, 61, 61)',
            ),
        ),
        '.op3-element[data-op3-element-type="row"]:eq(1)' => array(
            'all' => array(
                'paddingTop' => '0px',
                'paddingLeft' => '40px',
                'paddingBottom' => '50px',
                'paddingRight' => '40px',
                'backgroundColorBase' => '#f9f9f9',
            ),
        ),
        '.op3-element[data-op3-element-type="headline"]' => array(
            'all' => array(
                'color' => '#fff',
                'fontSize' => '33px',
                'marginBottom' => '0px',
        ...
        '.op3-element[data-op3-element-type="text"]:eq(0)' => array(
            'all' => array(
        ...
        '.op3-element[data-op3-element-type="text"]:eq(1)' => array(
            'all' => array(
