...
return array(
     ...
     * wrapper element).
     */
    'parent' => array('treemenu', 'treemenuitem'),
    ...
    'options' => array(
        'all' => array(
            'menuItemId' => '0',
            'op3Icon' => 'op3-icon-link-71-1',
            'dropdownIcon' => 'op3-icon-small-down',
            'href' => '#',
            'target' => '_self',
            "width" => 'auto',
        ...
        'screen and (max-width: 767px)' => array(
            'childWrapBorderAllWidth' => '0px',
            'childWrapBorderAllStyle' => 'none',
        ),
    ),
