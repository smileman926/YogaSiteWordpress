...
return array(
     ...
     */
    'thumb' => 'op3-icon op3-icon-ui-04-2',
    ...
    'assets' => array(
        ...
        op3_asset_path('js/op3-element-contenttoggle.js'),
    ),
    ...
    'presets' => array(
        array(
            'title' => 'Preset #1',
            'thumb' => op3_asset('img/elements/contenttoggle/styles/style-1.png'),
            'options' => array(
                'all' => array(
                    'contentToggleItemBackgroundColorOverlay' => '#f7f7f7',
                    'contentToggleItemFontSizeIcon' => '20px',
                    'contentToggleItemPaddingTop' => '15px',
                    'contentToggleItemPaddingBottom' => '15px',
                    'contentToggleItemPaddingLeft' => '15px',
                    'contentToggleItemPaddingRight' => '15px',
                    'contentToggleItemMarginBottom' => '15px',
                    'contentToggleItemBorderTopWidth' => '1px',
                    'contentToggleItemBorderTopColor' => '000',
                    'contentToggleItemBorderTopStyle' => 'solid',
                    'contentToggleItemBorderBottomWidth' => '1px',
                    'contentToggleItemBorderBottomColor' => '000',
                    'contentToggleItemBorderBottomStyle' => 'solid',
                    'contentToggleItemBorderLeftWidth' => '1px',
                    'contentToggleItemBorderLeftColor' => '000',
                    'contentToggleItemBorderLeftStyle' => 'solid',
                    'contentToggleItemBorderRightWidth' => '1px',
                    'contentToggleItemBorderRightColor' => '000',
                    'contentToggleItemBorderRightStyle' => 'solid',
                ),
            ),
        ),
    ),
