...
return array(
     ...
     */
    'thumb' => 'op3-icon op3-icon-number-block',
    ...
    'options' => array(
        'all' => array(
            'numberBlockFrame' => 'filled',
            'numberBlockShape' => 'circle',
            'padding' => '20px',
            'marginLeft' => 'auto',
            'marginRight' => 'auto',
            'marginLeftNumber' => '20px',
            'marginRightNumber' => '20px',
            'marginBottomNumber' => '10px',
            'blockLayoutDesktop' => '0',
            'blockLayoutTablet' => '0',
            'blockLayoutMobile' => '2',
            'blockDisplayTitle' => '1',
            'numberBlockSequence' => 'all',
            'borderTopWidthNumber' => '2px',
            'borderBottomWidthNumber' => '2px',
            'borderLeftWidthNumber' => '2px',
            'borderRightWidthNumber' => '2px',

            // Number block item
            'numberBlockItemColor' => '#fff',
            'numberBlockItemBackgroundNumberColorBase' => '#a8b4f7',
            'numberBlockItemMarginBottom' => '20px',
            'numberBlockItemPaddingTop' => '20px',
            'numberBlockItemPaddingBottom' => '20px',
            'numberBlockItemPaddingLeft' => '20px',
            'numberBlockItemPaddingRight' => '20px',
            'numberBlockItemBorderTopWidth' => '1px',
            'numberBlockItemBorderTopStyle' => 'solid',
            'numberBlockItemBorderTopColor' => '#efeeee',
            'numberBlockItemBorderBottomWidth' => '1px',
            'numberBlockItemBorderBottomStyle' => 'solid',
            'numberBlockItemBorderBottomColor' => '#efeeee',
            'numberBlockItemBorderLeftWidth' => '1px',
            'numberBlockItemBorderLeftStyle' => 'solid',
            'numberBlockItemBorderLeftColor' => '#efeeee',
            'numberBlockItemBorderRightWidth' => '1px',
            'numberBlockItemBorderRightStyle' => 'solid',
            'numberBlockItemBorderRightColor' => '#efeeee',
            'numberBlockItemBorderTopLeftRadius' => '5px',
            'numberBlockItemBorderTopRightRadius' => '5px',
            'numberBlockItemBorderBottomLeftRadius' => '5px',
            'numberBlockItemBorderBottomRightRadius' => '5px',
            ...
            // 'titleTextAlign' => "left", -> messes up the block layout
