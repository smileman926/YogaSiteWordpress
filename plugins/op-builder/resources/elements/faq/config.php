...
return array(
     ...
     */
    'thumb' => 'op3-icon op3-icon-ui-04-1',
     ...
     */
    'assets' => array(
        op3_asset_path('js/jquery-accordion.js'),
        op3_asset_path('js/op3-element-faq.js'),
    ),
    ...
    'presets' => array(
        array(
            'title' => 'Preset #1',
            'thumb' => op3_asset('img/elements/faq/styles/style-1.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    'paddingTop' =>  '15px',
                    'paddingBottom' =>  '15px',
                    'faqItemBoxShadow' =>  'rgba(0, 0, 0, 0) 0px 0px 0px 0px',
                    'faqItemBackgroundColorOverlay' =>  'rgb(255, 255, 255)',
                    'faqItemBorderTopWidth' =>  '1px',
                    'faqItemBorderTopStyle' =>  'solid',
                    'faqItemBorderTopColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderBottomWidth' =>  '1px',
                    'faqItemBorderBottomStyle' =>  'solid',
                    'faqItemBorderBottomColor' =>  'rgb(234, 234, 234)',
                    'faqItemBorderLeftWidth' =>  '0px',
                    'faqItemBorderLeftStyle' =>  'none',
                    'faqItemBorderLeftColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderRightWidth' =>  '0px',
                    'faqItemBorderRightStyle' =>  'none',
                    'faqItemBorderRightColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderTopLeftRadius' =>  '0px',
                    'faqItemBorderTopRightRadius' =>  '0px',
                    'faqItemBorderBottomLeftRadius' =>  '0px',
                    'faqItemBorderBottomRightRadius' =>  '0px',
                    'faqItemMarginBottom' =>  '-1px',
                    'faqItemPaddingTop' =>  '20px',
                    'faqItemPaddingBottom' =>  '20px',
                    'faqItemPaddingLeft' =>  '20px',
                    'faqItemPaddingRight' =>  '20px',
                    'faqItemFontSizeIcon' =>  '20px',
                    'faqItemFontSize' =>  '21px',
                    'faqItemFontWeight' =>  '700',
                    'textColor' =>  'rgb(98, 98, 98)',
                    'textBackgroundColorOverlay' =>  'rgb(255, 255, 255)',
                    'textPaddingTop' =>  '0px',
                    'textPaddingBottom' =>  '20px',
        ...
        array(
            'title' => 'Preset #2',
            'thumb' => op3_asset('img/elements/faq/styles/style-2.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    'paddingTop' =>  '15px',
                    'paddingBottom' =>  '15px',
                    'faqItemBackgroundColorOverlay' =>  'rgb(247, 247, 247)',
                    'faqItemBorderTopWidth' =>  '0px',
                    'faqItemBorderTopStyle' =>  'none',
                    'faqItemBorderBottomWidth' =>  '0px',
                    'faqItemBorderBottomStyle' =>  'none',
                    'faqItemBorderLeftWidth' =>  '0px',
                    'faqItemBorderLeftStyle' =>  'none',
                    'faqItemBorderRightWidth' =>  '0px',
                    'faqItemBorderRightStyle' =>  'none',
                    'faqItemMarginBottom' =>  '15px',
                    'faqItemPaddingTop' =>  '15px',
                    'faqItemPaddingBottom' =>  '15px',
                    'faqItemPaddingLeft' =>  '15px',
                    'faqItemPaddingRight' =>  '15px',
                    'faqItemFontSizeIcon' =>  '20px',
                    'textPaddingTop' => '15px',
                    'textPaddingBottom' =>  '15px',
                    'textPaddingLeft' =>  '15px',
                    'textPaddingRight' =>  '15px',
                    'textMarginBottom' => '0px',
                ),
            ),
        ),
        array(
            'title' => 'Preset #3',
            'thumb' => op3_asset('img/elements/faq/styles/style-3.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    ...
                    'faqItemBorderBottomWidth' =>  '1px',
                    'faqItemBorderBottomStyle' =>  'solid',
                    'faqItemBorderBottomColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderLeftWidth' =>  '1px',
                    'faqItemBorderLeftStyle' =>  'solid',
                    'faqItemBorderLeftColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderRightWidth' =>  '1px',
                    'faqItemBorderRightStyle' =>  'solid',
                    'faqItemBorderRightColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderTopLeftRadius' =>  '5px',
                    'faqItemBorderTopRightRadius' =>  '5px',
                    'faqItemBorderBottomLeftRadius' =>  '5px',
                    'faqItemBorderBottomRightRadius' =>  '5px',
                    'faqItemMarginBottom' =>  '15px',
                    'faqItemPaddingTop' =>  '15px',
                    'faqItemPaddingBottom' =>  '15px',
                    'faqItemPaddingLeft' =>  '15px',
        ...
        array(
            'title' => 'Preset #4',
            'thumb' => op3_asset('img/elements/faq/styles/style-4.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    'paddingTop' =>  '15px',
                    'paddingBottom' =>  '15px',
                    'faqItemBoxShadow' =>  'rgba(0, 0, 0, 0.23) 0px 0px 13px -6px',
                    'faqItemBackgroundColorOverlay' =>  'rgb(255, 255, 255)',
                    'faqItemBorderTopWidth' =>  '1px',
                    'faqItemBorderTopStyle' =>  'none',
                    'faqItemBorderTopColor' =>  'rgba(240, 240, 240, 0.9)',
                    ...
                    'faqItemBorderRightStyle' =>  'none',
                    'faqItemBorderRightColor' =>  'rgba(240, 240, 240, 0.9)',
                    'faqItemBorderTopLeftRadius' =>  '10px',
                    'faqItemBorderTopRightRadius' =>  '10px',
                    'faqItemBorderBottomLeftRadius' =>  '10px',
                    'faqItemBorderBottomRightRadius' =>  '10px',
                    'faqItemMarginBottom' =>  '24px',
                    'faqItemPaddingTop' =>  '25px',
                    'faqItemPaddingBottom' =>  '25px',
                    'faqItemPaddingLeft' =>  '15px',
                    'faqItemPaddingRight' =>  '15px',
                    'faqItemFontSizeIcon' =>  '20px',
                    'faqItemFlexDirection' =>  'row-reverse',
                    'faqItemJustifyContent' =>  'flex-end',
                    'faqItemIconPaddingRight' =>  '15px',
                    'textColor' =>  'rgb(125, 125, 125)',
                    'textBackgroundColorOverlay' =>  'rgb(255, 255, 255)',
                    'textPaddingTop' =>  '0px',
                    'textPaddingBottom' =>  '25px',
                    'textPaddingLeft' =>  '25px',
                    'textPaddingRight' =>  '25px',
                    'textMarginBottom' => '0px',
                ),
            ),
        ),
        array(
            'title' => 'Preset #5',
            'thumb' => op3_asset('img/elements/faq/styles/style-5.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    'paddingTop' =>  '15px',
                    'paddingBottom' =>  '15px',
                    'faqItemColor' =>  'rgb(255, 255, 255)',
                    'faqItemBackgroundColorOverlay' =>  'rgb(34, 34, 34)',
                    'faqItemBorderTopWidth' =>  '0px',
                    'faqItemBorderTopStyle' =>  'none',
                    'faqItemBorderBottomWidth' =>  '0px',
                    'faqItemBorderBottomStyle' =>  'none',
                    ...
                    'faqItemPaddingTop' =>  '25px',
                    'faqItemPaddingBottom' =>  '25px',
                    'faqItemPaddingLeft' =>  '25px',
                    'faqItemPaddingRight' =>  '25px',
                    'faqItemFontSizeIcon' =>  '20px',
                    'textColor' =>  'rgba(255, 255, 255, 0.9)',
                    'textBackgroundColorOverlay' =>  'rgb(62, 62, 62)',
                    'textPaddingTop' =>  '25px',
                    'textPaddingBottom' =>  '25px',
                    'textPaddingLeft' =>  '25px',
                    'textPaddingRight' =>  '25px',
        ...
        array(
            'title' => 'Preset #6',
            'thumb' => op3_asset('img/elements/faq/styles/style-6.png'),
            'options' => array(
                'all' => array(
                    'marginLeft' =>  '0px',
                    'marginRight' =>  'auto',
                    ...
                    'paddingBottom' =>  '15px',
                    'faqItemColor' =>  'rgb(255, 255, 255)',
                    'faqItemBackgroundColorOverlay' =>  'rgb(0, 65, 255)',
                    'faqItemBorderTopWidth' =>  '0px',
                    'faqItemBorderTopStyle' =>  'none',
                    'faqItemBorderBottomWidth' =>  '0px',
                    'faqItemBorderBottomStyle' =>  'none',
                    ...
                    'faqItemBorderRightWidth' =>  '0px',
                    'faqItemBorderRightStyle' =>  'none',
                    'faqItemBorderTopLeftRadius' =>  '12px',
                    'faqItemBorderTopRightRadius' =>  '12px',
                    'faqItemBorderBottomLeftRadius' =>  '12px',
                    'faqItemBorderBottomRightRadius' =>  '12px',
                    'faqItemMarginBottom' =>  '15px',
                    'faqItemPaddingTop' =>  '20px',
                    'faqItemPaddingBottom' =>  '20px',
                    'faqItemPaddingLeft' =>  '20px',
                    'faqItemPaddingRight' =>  '20px',
                    'faqItemFontSizeIcon' =>  '20px',
                    'textColor' =>  'rgba(22, 22, 22, 0.79)',
                    'textBackgroundColorOverlay' =>  'rgb(251, 251, 251)',
                    'textPaddingTop' =>  '25px',
                    'textPaddingBottom' =>  '25px',
                    'textPaddingLeft' =>  '25px',
                    'textPaddingRight' =>  '25px',
