...
return array(
    ...
    'options' => array(
        'all' => array(
            ...
            'requiredFull' => '',
            'visibleLock' => '0',
            'op3Icon' => 'op3-icon-chat-round-2',
            'iconFlexDirection' => 'right',
            'iconMarginLeft' => '0.25em',
            'iconMarginRight' => '0em',
            'inputValidationMessage' => 'This field is required.',
            'urlMapping' => '',
        ),
    ),
    ...
    /**
     * Boolean / String
     * A button on the sidebar headline to focus the parent element.
     * If string is provided here, it will be used as text
     * for the button, if true, the standard button
     * text defined in the template will be used.
     */
    'focusParentElementButton' => 'Back to Form Fields',
);
