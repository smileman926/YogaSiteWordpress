...
return array(
    ...
    'assets' => array(
        ...
        op3_asset_path('js/op3-element-countdowntimer.js'),
    ),
    ...
    'options' => array(
        'all' => array(
            'dateTime' => date('Y-m-d\TH:i', strtotime("+3 day")),
            'countdownFinishAction'  => 'redirect',
    ...
    'presets' => array(
        array(
            'title'   => 'Preset 1',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-1.png'),
            'options' => array(
                'all' => array(
        ...
        array(
            'title'   => 'Preset 2',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-2.png'),
            'options' => array(
                'all' => array(
                    'fontFamily' => 'Karla, sans-serif',
                    'fontWeight' => '700',
        ...
        array(
            'title'   => 'Preset 3',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-3.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '400',
                    // wrapper
        ...
        array(
            'title'   => 'Preset 4',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-4.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '400',
                    // wrapper
        ...
        array(
            'title'   => 'Preset 5',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-5.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '700',
                    'digitsFontSize' => '30px',
        ...
        array(
            'title'   => 'Preset 6',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-6.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '600',
                    'digitsFontSize' => '34px',
        ...
        array(
            'title'   => 'Preset 7',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-7.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '700',
                    'digitsFontSize' => '48px',
        ...
        array(
            'title'   => 'Preset 8',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-8.png'),
            'options' => array(
                'all' => array(
                    'digitsFontSize' => '36px',
                    'fontWeight' => '700',
        ...
        array(
            'title'   => 'Preset 9',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-9.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '600',
                    // wrapper
        ...
        array(
            'title'   => 'Preset 10',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-10.png'),
            'options' => array(
                'all' => array(
                    'fontWeight' => '700',
                    // wrapper
        ...
        array(
            'title'   => 'Preset 11',
            'thumb'   => op3_asset('img/elements/countdowntimer/styles/style-11.png'),
            'options' => array(
                'all' => array(
                    // wrapper
                    'flexDirection' => 'row',
