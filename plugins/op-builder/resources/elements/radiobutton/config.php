...
return array(
    ...
    'options' => array(
        'all' => array(
            'html' => 'Default Label',
            'options' => '<div><input type="radio" name="" value="Some value" /><label>Some value</label></div><div><input type="radio" name="" value="Default value" selected /><label>Default value</label></div></div>',
        ),
    ),
