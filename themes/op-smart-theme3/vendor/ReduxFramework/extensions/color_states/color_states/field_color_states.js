...
(function( $ ) {
    ...
    redux.field_objects.color_states = redux.field_objects.color_states || {};
    ...
    redux.field_objects.color_states.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-color_states:visible' );
        }
